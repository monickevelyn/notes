...
export default function ContainerNote({ text, onClick, id }) {
  return (
    <>
      <div
        id={id}
        className="w-72 h-52 roundedfont-normal text-1xl flex flex-col justify-start items-start gap-4 break-all overflow-y-auto"
      ...
      >
        ...
        <p className="text-left p-2">{text}</p>
      </div>
    </>
  );
}
